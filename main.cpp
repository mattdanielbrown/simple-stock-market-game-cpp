...
/*
  ...
  tips[1] = {"1Buy Low and Sell High for MASSIVE GAINS!!!","'2Stock Market Game is the best financial trainer out there'- Warren Buffet","35,000 Runs and Climbing! Possibly the best game on Repl.it?","4Tell me in the comments how much you made I love to here it!","5If only this were possible in real life!","6Did you hear about that hamster that outperformed the S&P 500!!!","7Thank You for playing my game! :)","Best of luck out there!","8I'm curious where are you guys from? Tell me in the comments!","9What do you guys like about this game and are there any bugs that I need to fix, Tell me in the comments!","'10The best trainer for all diamond holding apes'-r/wallstreetbets","11Just a reminder, your the best!","Like the new update?","Notch!","12As seen on TV!","13SPLASH!"};
  


  displayTip = rand() % 3 + 0;
  std::cout << tips[displayTip];
*/
